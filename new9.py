...
# Submit button
btnsubmit1 = Button(root, padx=16, bd=10, fg="white", font=('arial', 10, 'bold'), width=7, text="SUBMIT", bg="grey",command = callMain)
...
# # labels for the no of page entry
# lblpage = Label(root, font=('arial', 16, 'bold'),
#                text="Enter the No. of pages", bd=16, anchor="w")
# lblpage.grid(row=8, column=1)
# lblpage["bg"]="grey"



# # Entry box for the no of page entry
# txtpage = Entry(root, font=('arial', 16, 'bold'), bd=10, insertwidth=4,
#                bg="powder blue", justify='right')
# txtpage.grid(row=8, column=3)
# txtpage["bg"]="grey"


# Submit button
btnsubmit2 = Button(root, padx=16, bd=10, fg="white", font=('arial', 10, 'bold'), width=30, text="BEGIN SPIDERING ", bg="grey",command = callSec)
